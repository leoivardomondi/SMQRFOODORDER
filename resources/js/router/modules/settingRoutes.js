...
import WhatsappApiComponent from "../../components/admin/settings/Whatsapp/WhatsappApiComponent";
...
export default [
    {
        ...
        children: [
            ...
            {
                path: "whatsapp-api",
                component: WhatsappApiComponent,
                name: "admin.settings.whatsappApi",
                meta: {
                    isFrontend: false,
                    auth: true,
                    permissionUrl: "settings",
                    breadcrumb: "whatsapp_api_setup"
                }
            },
            {
                path: "license",
