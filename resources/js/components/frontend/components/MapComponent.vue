<template>
    <div class="w-full max-w-[630px] rounded-2xl bg-white">
        ...
        <div v-if="setting.autocomplete || setting.currentLocation"
            class="map-search-control w-full h-12 mb-4 shadow-xs rounded-lg flex items-center gap-5 pl-[18px] pr-2.5 bg-white">
            ...
            <input v-if="setting.autocomplete" id="map-autocomplete-input" type="text" placeholder="Enter a location"
                class="map-search-input w-full h-full placeholder:text-lg placeholder:font-normal placeholder:font-public text-lg font-public">
            <button v-if="setting.currentLocation" id="map-current-location" type="button"
                class="map-location-button flex-shrink-0 w-7 h-7 rounded flex items-center justify-center bg-primary">
