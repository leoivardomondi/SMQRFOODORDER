``<template>
    ...
    <section class="order-details-page pt-6 pb-24 sm:pt-8 sm:pb-16">
        <div class="container max-w-3xl">
            ...
            <div class="flex items-start flex-col md:flex-row gap-6">
                <div class="w-full">
                    ...
                    <div v-if="parseInt(order.status) !== parseInt(enums.orderStatusEnum.REJECTED) && parseInt(order.status) !== parseInt(enums.orderStatusEnum.CANCELED)"
                        ...
                        <a :href="order.payment_url"
                            v-if="setting.site_online_payment_gateway === enums.activityEnum.ENABLE && order.transaction === null && order.payment_status === enums.paymentStatusEnum.UNPAID && order.payment_url"
                ...
                <div class="w-full rounded-2xl shadow-xs bg-white">
                    ...
                    <div class="p-4"
                        v-if="order.status === enums.orderStatusEnum.PENDING && order.payment_status !== enums.paymentStatusEnum.PAID">
