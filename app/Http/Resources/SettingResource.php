...
class SettingResource extends JsonResource
{
    ...
    public function toArray($request): array
    {
        return [
            ...
            'theme_muted_surface_color'             => $this->info['theme_muted_surface_color'] ?? '#f8fafc',
            'theme_input_background_color'          => $this->info['theme_input_background_color'] ?? '#ffffff',
            'theme_muted_text_color'                => $this->info['theme_muted_text_color'] ?? '#64748b',
            'theme_modal_overlay_color'             => $this->info['theme_modal_overlay_color'] ?? 'rgba(15, 23, 42, 0.48)',
