...
Route::prefix('admin')->name('admin.')->middleware(['installed', 'apiKey', 'auth:sanctum', 'localization'])->group(function () {
    ...
    Route::prefix('setting')->name('setting.')->middleware('superAdmin')->group(function () {
        ...
        Route::prefix('whatsapp-api')->name('whatsapp-api.')->group(function () {
            Route::get('/', [WhatsappApiController::class, 'index']);
            Route::post('/', [WhatsappApiController::class, 'update']);
            Route::post('/test', [WhatsappApiController::class, 'test']);
        });
        ...
        Route::prefix('payment-gateway')->name('payment-gateway.')->group(function () {
            ...
            Route::post('/set-primary', [PaymentGatewayController::class, 'setPrimary']);
        });
    ...
    Route::prefix('administrator')->name('administrator.')->group(function () {
        ...
        Route::post('/send-setup-invitations', [AdministratorController::class, 'sendSetupInvitations']);
...
Route::prefix('frontend')->name('frontend.')->middleware(['installed', 'apiKey', 'localization'])->group(function () {
    ...
    Route::prefix('delivery-boy-order')->name('delivery-boy-order.')->middleware(['auth:sanctum'])->group(function () {
        ...
        Route::post('/claim/{order}', [FrontendDeliveryBoyOrderController::class, 'claim']);
    });
